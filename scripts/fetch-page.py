...
Uso:
    python fetch-page.py https://fifaindex.com/.../fc26
    (o con la env var PAGE_URL)
...
URL = (
    os.environ.get("PAGE_URL")
    or (sys.argv[1] if len(sys.argv) > 1 else None)
    or "https://fifaindex.com/es-mx/clasificaciones/wonderkids/midfielders/fc26"
)
